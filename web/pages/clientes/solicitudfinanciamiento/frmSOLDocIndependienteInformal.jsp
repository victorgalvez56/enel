    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="onload()">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <s:form action="frmSOLDocIndependienteInformal" enctype="multipart/form-data" method="post">
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteIReciboLuz" cssClass="form-control"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Copia de DNI:</label>

                                                        <s:file name="archivoSolFinan_IndependienteICopiaDni" cssClass="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>               
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteICertificadoProveedor1" cssClass="form-control"/>
                                                        <s:file name="archivoSolFinan_IndependienteICertificadoProveedor2" cssClass="form-control"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteIFactura1" cssClass="form-control"/>
                                                        <s:file name="archivoSolFinan_IndependienteIFactura2" cssClass="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteICertificadoExp1" cssClass="form-control"/>
                                                        <s:file name="archivoSolFinan_IndependienteICertificadoExp2" cssClass="form-control"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Extracto de la AFP (si lo tiene).:</label>
                                                        <s:file name="archivoSolFinan_IndependienteIExtracAfp" cssClass="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteICopiaArrendamiento" cssClass="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
