    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="onload()">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <s:form action="frmSOLDocIndependienteFormal" enctype="multipart/form-data" method="post">
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteFReciboLuz" cssClass="form-control"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Copia de DNI:</label>

                                                        <s:file name="archivoSolFinan_IndependienteFCopiaDni" cssClass="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>               
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteFCopiaRuc" cssClass="form-control"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Extractos bancarios de los últimos tres meses:</label>
                                                        <s:file name="archivoSolFinan_IndependienteFExtracBanc1" cssClass="form-control"/>
                                                        <s:file name="archivoSolFinan_IndependienteFExtracBanc2" cssClass="form-control"/>
                                                        <s:file name="archivoSolFinan_IndependienteFExtracBanc3" cssClass="form-control"/>
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteFExtracAfp" cssClass="form-control"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_IndependienteFCopiaArrendamiento" cssClass="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
