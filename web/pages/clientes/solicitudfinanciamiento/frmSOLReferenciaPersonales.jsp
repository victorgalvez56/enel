    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="onload()">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <s:form action="frmSOLReferenciaPersonales" role="form">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <s:textfield type="text" cssClass="form-control"  tabindex="1" name="solCLI_refepersonPrimerNomb" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Segundo Nombre:  </label>
                                                            <s:textfield type="text" cssClass="form-control"  tabindex="2" name="solCLI_refepersonSegundoNomb" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Primer Apellido:  </label>
                                                            <s:textfield type="text" cssClass="form-control"  tabindex="3" name="solCLI_refepersonPrimerApel" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Segundo Apellido:  </label>
                                                            <s:textfield type="text" cssClass="form-control"  tabindex="4" name="solCLI_refepersonSegundoApel" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <s:textfield type="text" cssClass="form-control"  tabindex="5" name="solCLI_refepersonDireccion" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Distrito:  </label>
                                                            <s:select name="solCLI_refepersonDistrito" tabindex="6"  list="lstTipZon" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="-- Seleccione --" cssClass="form-control" readonly="true" />    
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Provincia:  </label>
                                                            <s:select name="solCLI_refepersonProvincia" tabindex="7"  list="lstTipZon" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="-- Seleccione --" cssClass="form-control" readonly="true" />    
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Estado:  </label>
                                                            <s:textfield type="text" cssClass="form-control"  tabindex="8" name="solCLI_refepersonEstado" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <s:textfield type="number" cssClass="form-control"  tabindex="9" name="solCLI_refepersonTelefono" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Celular:  </label>
                                                            <s:textfield type="number" cssClass="form-control"  tabindex="10" name="solCLI_refepersonCelular" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Parentesco:  </label>
                                                            <s:textfield type="text" cssClass="form-control"  tabindex="11" name="solCLI_refepersonParentesco" style="text-transform: uppercase;" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style="float: right">
                                            ...
                                            <s:submit name="siguientePerso" value="Siguiente"tabindex="12"  id = "bAplicar" cssClass="btn btn-primary btn-flat" />
                                        </div>
