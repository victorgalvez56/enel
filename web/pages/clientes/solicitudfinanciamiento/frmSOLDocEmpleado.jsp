    ...
    <body class="hold-transition skin-blue sidebar-mini" onload="onload()">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <s:form action="frmSOLDocEmpleado" enctype="multipart/form-data" method="post">
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <s:file name="archivoSolFinan_EmpleadoRecibo" cssClass="form-control"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Copia de DNI:</label>

                                                        <s:file name="archivoSolFinan_EmpleadoCopiaDni" cssClass="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        <label class="control-label">Boletas de nómina de los últimos tres meses:</label>
                                                        <s:file name="archivoSolFinan_EmpleadoBoleta1" cssClass="form-control"/>
                                                        <s:file name="archivoSolFinan_EmpleadoBoleta2" cssClass="form-control"/>
                                                        <s:file name="archivoSolFinan_EmpleadoBoleta3" cssClass="form-control"/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Si tiene ingresos adicionales por alquileres incluir copia del contrato de arrendamiento:</label>
                                                        <s:file name="archivoSolFinan_EmpleadoCopiaArrendamiento" cssClass="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
