                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <s:textfield cssClass="form-control" id="tfSuministro" tabindex="2" name="cliente.sumini" required="true" onblur="desplegarDireccion();" style="text-transform: uppercase;" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
