                                        ...
                                        <div class="box box-primary box-solid">
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="col-md-1">
                                                        <div class="form-group">
                                                            <label class="control-label">Primero Nombre: </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="form-group">
                                                            <label class="control-label">Primero Apellido: </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <s:select name="cliente.tipDocCiv" tabindex="10" id="sTipoDoc" list="lstEstados" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="-- Seleccione --" cssClass="form-control" readonly="true" />    
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="form-group">
                                                            <label class="control-label">Ocupción: </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
