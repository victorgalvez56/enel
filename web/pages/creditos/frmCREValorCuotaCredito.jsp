                                                                ...
                                                                <tbody>
                                                                    <s:iterator value="lstVerificacionesB" status="rowStatus">
                                                                        <tr style="text-transform: uppercase;">
                                                                            ...
                                                                            <td width="85" nowrap><s:textfield name="cuotaTitular" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaFamiliar" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaInquilino" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaTaxista" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaMilOficio" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaEmprendedor" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaAma" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaEmpleada" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaJubilado" cssClass="form-control" readonly="true"/></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotaRemesa" cssClass="form-control" readonly="true"/></td>
                                                                        </tr>
                                                                    </s:iterator>
                                                                </tbody>
                                                            </table><br>
