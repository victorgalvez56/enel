    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <s:form action="frmCREMntPlazos" role="form">
                                                                ...
                                                                <tbody>
                                                                    <s:iterator value="lstVerificacionesB" status="rowStatus">
                                                                        <tr style="text-transform: uppercase;">
                                                                            ...
                                                                            <td width="85" nowrap><s:textfield name="cuotasTitular" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasFamiliar" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasInquilino" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasTaxista" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasMilOficio" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasEmprendedor" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasAma" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasEmpleada" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasJubilado" cssClass="form-control" /></td>
                                                                            <td width="85" nowrap><s:textfield name="cuotasRemesa" cssClass="form-control" /></td>
