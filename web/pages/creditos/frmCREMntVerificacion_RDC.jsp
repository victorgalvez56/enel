                                                                    ...
                                                                    <s:iterator value="lstVerifiPerfCB" status="rowStatus">
                                                                        <s:if test="true">
                                                                            ...
                                                                            <s:form action="frmCREMntVerificacion_RDC" role="form">
                                                                                ...
                                                                                <td width="120" nowrap data-th="Taxistas"><s:select name="taxista" tabindex="4" list="lstVerificacion" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="---" cssClass="form-control"/></td>
                                                                                <td width="120" nowrap data-th="Mil oficios"><s:select name="milOficio" tabindex="5" list="lstVerificacion" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="---" cssClass="form-control"/></td>
                                                                                <td width="120" nowrap data-th="Emprendedores"><s:select name="emprendedor" tabindex="6" list="lstVerificacion" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="---" cssClass="form-control"/></td>
                                                                                <td width="120" nowrap data-th="Amas de casa"><s:select name="ama" tabindex="7" list="lstVerificacion" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="---" cssClass="form-control"/></td>
                                                                                <td width="120" nowrap data-th="Empleadas del hogar"><s:select name="empleada" tabindex="8" list="lstVerificacion" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="---" cssClass="form-control"/></td>
                                                                                <td width="120" nowrap data-th="Jubilado, pensionista"><s:select name="jubilado" tabindex="9" list="lstVerificacion" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="---" cssClass="form-control"/></td>
                                                                                <td width="120" nowrap data-th="Remesas"><s:select name="remesa" tabindex="10" list="lstVerificacion" listKey="codigo" listValue="descripcion" headerKey="0" headerValue="---" cssClass="form-control"/></td>
