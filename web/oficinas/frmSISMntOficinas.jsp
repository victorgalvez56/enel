                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <s:form action="frmSisMntOficinas" role="form">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <s:textfield name="oficina.codOfi" cssClass="form-control" tabindex="1"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <s:textfield name="oficina.nombre" cssClass="form-control" tabindex="2"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <div class="table-responsive col-md-6">
                                    <table class="table">
                                        ...
                                        <s:iterator value="lstOficinas">
                                            <tr>
                                                <td data-th="Código"><s:property value="codOfi"/></td>
